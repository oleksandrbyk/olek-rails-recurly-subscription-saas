...
These features are not included in this application. See the "rails3-subdomains":https://github.com/oleksandrbyk/olek-rails-subdomains example application for help with subdomains. For multitenancy, try Brad Robertson's "Apartment":https://github.com/bradrobertson/apartment gem.
...
Problems? Check the "issues":https://github.com/oleksandrbyk/olek-rails-recurly-subscription-saas/issues.
...
Please create a "GitHub issue":http://github.com/oleksandrbyk/olek-rails-recurly-subscription-saas/issues if you identify any problems or have suggestions for improvements.
...
Send the author a message, create an "issue":http://github.com/oleksandrbyk/olek-rails-recurly-subscription-saas/issues, or fork the project and submit a pull request.
